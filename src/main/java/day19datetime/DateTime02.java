...
//Example 1: Java'dan aldiginiz Date'i "ay/gun/yil" olarak yaziniz
        ...
        //Examle 2: Java'dan aldiginiz Time'ın formatini degistiriniz
        LocalTime mytime = LocalTime.of(04,23,54,2345);
        System.out.println(mytime);

        DateTimeFormatter dtf7= DateTimeFormatter.ofPattern("HH:mm ");// Buyuk HH 24 saat sistemini
        // kucuk hh 12 saat sistemini kullanir
